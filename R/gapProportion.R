...
#' \code{\link[trajectories:Track-class]{Track}} object) relative to the total duration of
#' the intersection of the \code{\link[trajectories:Track-class]{Track}} object and a
...
#' \code{\link[trajectories:Track-class]{Track}} object [s] divided by the total duration of the
#' intersection between the \code{\link[trajectories:Track-class]{Track}} object and the
