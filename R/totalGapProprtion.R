...
#' \code{\link[trajectories]{Track}} objects within a given
#' \code{\link[trajectories]{Tracks}} object relative to the total duration of
#' the intersection of the \code{\link[trajectories]{Tracks}} object and a
...
#' \code{\link[trajectories]{Tracks}} object [s] divided by the total duration of the
#' intersection between the \code{\link[trajectories]{Tracks}} object and the
