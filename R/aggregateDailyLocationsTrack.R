...
#' Aggregates a \code{\link[trajectories]{Track} object to Daily Resolution and to Locations.
#'
#' \code{aggregateDailyLocationsTrack} aggregates the data values
#' of a \code{\link[trajectories]{Track} object that has been 
...
#' @return An object of class \code{\link[trajectories]{Track}} that represents the
#' input \code{\link[trajectories]{Track}} object (\code{currenttrack}) that is aggregated
