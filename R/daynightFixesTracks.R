...
#' \code{\link[trajectories::Track-class]{Track}} object of a given
#' \code{\link[trajectories::Track-class]{Tracks}} objectin two classes on a
...
#' of the slot \code{data} of the \code{\link[trajectories::Track-class]{Track}}
